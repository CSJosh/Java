...
public class Project1 {
  public static void printReadMe() {
    System.out.println("\n\n***HERE IS THE README***: Josh Aldridge, Project 3, CS410J" +
            ...
            "  Date and time should be in the format: mm/dd/yyyy hh:mm (or mm/dd/yy hh:mm)\n" +
            "\n***END OF README***\n");
  }
  ...
  public static void parseCommandLine(ArrayList<String> argList, ArrayList<String> optList, String[] args) {
    ...
    for (String arg : args) {
      if (arg.length() != 0 && arg.charAt(0) == '-') {
        ...
        optList.add(arg);
        fileFound = false;
      } else if(prettyPrintFile) {
        optList.add(arg);
        prettyPrintFile = false;
      } else {
        argList.add(arg);
      }
    }
